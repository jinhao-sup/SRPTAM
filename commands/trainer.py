...
class Trainer:
    ...
    def __init__(self, sess, model, params):
        ...
        self.n_valid_users = self.params['training'].get('n_valid_users', 10000)
        self.num_negtives = self.params['training'].get('num_negatives', 100)
    ...
    def fit(self, data):
        ...
        timespan = model_params['params'].get('timespan', 256)
